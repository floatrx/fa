...
export const FA_THEMES = [
  ...
  'fatl',
  'fawsb',
  'fab', // include brand icons (for compatibility with main themes)
] as const;

export const FA_BRAND_THEMES = ['fab'] as const;
